...
addon_info = AddonInfo(
	...
	addon_description=_("""An NVDA add-on that lets you assign a friendly name and an optional keyboard shortcut to any UI element in any application or web page. Once marked, you can jump directly to that element at any time by pressing its shortcut, or by selecting it from a list.
...
This is especially useful in remote assistance scenarios (Teams - Remote Control, TeamViewer, AnyDesk, etc.) where a sighted helper can position the mouse over an important but unlabeled element, and the NVDA user can then mark it permanently so they can access it independently in future sessions."""),
	...
	addon_changelog=_("""Version 1.0.0 - Initial release
- Mark elements under mouse pointer (NVDA+Alt+N)
- Mark elements at navigator/caret (NVDA+Alt+B)
- Marker list for activation, editing, and deletion (NVDA+Alt+L)
...
- Toggle label announcements on/off (NVDA+Alt+A)"""),
	...
	addon_sourceURL="https://github.com/bhargav-vision-aid/VA-HFI2026-Team2",
